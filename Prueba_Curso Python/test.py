...
chromedriver_path = chromedriver_path = r'C:\Users\Sandra\Desktop\Python\Prueba_Curso Python\chromedriver.exe'
...
codigo.send_keys("2022100860")
sleep(10)
password = driver.find_element(By.ID, "password")
password.send_keys("unida1010")
sleep(10)
